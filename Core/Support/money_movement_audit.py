...
def load_state_bundle(state_dir: Path | None = None) -> Dict[str, Any]:
    ...
    return {
        ...
        "target_freshness_audit": _read_json(state_dir / "target_freshness_audit.json", {}),
        "ai_actual_usage_audit": _read_json(state_dir / "ai_actual_usage_audit.json", {}),
        "autonomous_runtime_readiness_audit": _read_json(state_dir / "autonomous_runtime_readiness_audit.json", {}),
        "server_extensions_usage_audit": _read_json(state_dir / "server_extensions_usage_audit.json", {}),
        "repo_safety_audit": _read_json(state_dir / "repo_safety_audit.json", {}),
        "trading_decision_policy_audit": _read_json(state_dir / "trading_decision_policy_audit.json", {}),
