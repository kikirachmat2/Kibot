...
PROMPT_PROVIDER_ORDER = {
    "BRAIN_CRITIC": ["ollama", "openrouter", "groq", "gemini", "nvidia", "cohere", "jina"],
    "PAIR_DISCOVERY": ["ollama", "openrouter", "groq", "gemini", "nvidia", "cohere", "jina"],
    "WHATIF_SIMULATION": ["ollama", "openrouter", "groq", "gemini", "nvidia", "cohere", "jina"],
    "TRADE_POSTMORTEM": ["ollama", "openrouter", "groq", "gemini", "nvidia", "cohere", "jina"],
    "VETO_ANALYSIS": ["ollama", "groq", "openrouter", "gemini", "nvidia", "cohere", "jina"],
    "WEEKLY_SUMMARY": ["ollama", "openrouter", "groq", "gemini", "nvidia", "cohere", "jina"],
    "NEWS_ANALYSIS": ["ollama", "openrouter", "groq", "gemini", "nvidia", "cohere", "jina"],
    ...
    "OPS_CHAT": ["ollama", "openrouter", "groq", "gemini", "nvidia", "cohere", "jina"],
