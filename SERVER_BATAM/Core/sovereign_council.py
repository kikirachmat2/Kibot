...
class SovereignCouncil:
    ...
    async def deliberate(self, issue_context: Dict) -> Dict:
        ...
        obs_analysis = await self._query_ollama("qwen3:0.5b", obs_prompt, "You are a strict KiBot System Auditor.")
        ...
        diagnosis = await self._query_ollama("qwen3:1.5b", diag_prompt, "You are the KiBot Diagnostician. Be precise.")
        ...
        strategies = await self._query_ollama("qwen3:1.5b", strat_prompt, "You are a Tactical War-Room Strategist. Analyze the Black Swan risks.")
        ...
        decision_raw = await self._query_ollama("qwen3:0.5b", arb_prompt, "You are the Final Arbiter. Output JSON only.")
