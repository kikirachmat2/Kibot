...
def test_healthcheck_accepts_web3_state_schema(tmp_path, monkeypatch):
    ...
    (state_dir / "web3_opportunities.json").write_text('{"updated_at":"2026-05-19T00:00:00Z","best_opportunities":[],"rejected":[],"routes":{}}')
    ...
    monkeypatch.setenv("KIBOT_PHANTOM_SCOUT_ENABLED", "false")
