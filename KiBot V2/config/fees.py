"""
KiBot V2 — Single Source of Truth for Indodax IDR Market (PRO) Trading Fees.
...
# These exit reasons imply URGENT / taker execution in live trading.
# Paper sim uses sell_taker_pct for these to be conservative.
...
# These exits are patient / can use limit order on exit.
